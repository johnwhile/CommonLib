...
{
    /// <summary>
    /// WParam flag for windows message WM_POWERBROADCAST 
    /// https://msdn.microsoft.com/it-it/library/windows/desktop/aa373247(v=vs.85).aspx
    /// </summary>
    public enum PBT : long
    {
        /// <summary>
        ...
        APMBATTERYLOW = 9,
        /// <summary>
        /// OEM-defined event occurred. In Windows Server 2008 and Windows Vista,
        /// this event is not available because these operating systems support only ACPI; APM BIOS events are not supported. 
        /// </summary>
        APMOEMEVENT = 11,
        /// <summary>
    ...
    /// <summary>
    /// WParam flag for windows message WM_ACTIVATE
    ...
    public enum WA : long
    {
        ...
        INACTIVE = 0,
        /// <summary>
        /// Activated by some method other than a mouse click (for example, by a call to the SetActiveWindow function or
        /// by use of the keyboard interface to select the window).
        /// </summary>
        ACTIVE = 1,
        /// <summary>
    ...
    /// <summary>
    /// WParam flag for windows message WM_SIZE
    /// The low-order word of lParam specifies the new width of the client area.
    /// The high-order word of lParam specifies the new height of the client area.
    /// https://msdn.microsoft.com/it-it/library/windows/desktop/ms632646(v=vs.85).aspx
    /// </summary>
    ...
    /// <summary>
    /// WParam flag for windows message WM_SYSCOMMAND
    ...
    /// if a window menu command is chosen with the mouse. This parameter is 1 if the command is chosen
    ...
    /// <summary>
    /// WParam flag for windows message WM_MENUCHAR
    ...
    /// <summary>
    /// WParam flag for windows message WM_MOUSE
    ...
    /// <summary>
    /// WParam flag for windows message WM_NCHITTEST
    /// Sent to a window in order to determine what part of the window corresponds to a particular screen coordinate.
    /// </summary>
    /// <remarks>
    /// from -2 to 21, missing: 19
    /// </remarks>
    public enum HT : long
    {
        /// <summary>
    ...
    /// <summary>
    /// WINDOWS MESSAGE
    /// From http://www.pinvoke.net/default.aspx/Enums/WindowsMessages.html
    ...
    public enum WM : uint
    {
        ...
        CREATE = 0x0001,
        /// <summary>
        /// The WM_DESTROY message is sent when a window is being destroyed. It is sent to the window procedure of the window being destroyed after
        /// the window is removed from the screen. This message is sent first to the window being destroyed and then to the child windows (if any) as
        /// they are destroyed. During the processing of the message, it can be assumed that all child windows still exist.
        /// </summary>
        DESTROY = 0x0002,
        /// <summary>
        ...
        PAINTICON = 0x0026,
        /// <summary>
        /// Windows NT 3.51 and earlier: The WM_ICONERASEBKGND message is sent to a minimized window when the background of the icon must be filled
        /// before painting the icon. A window receives this message only if a class icon is defined for the window; otherwise, WM_ERASEBKGND is sent.
        ...
        /// <br>see <b>(<see cref="HT"/>)wparam</b></br>
        /// </summary>
        NCHITTEST = 0x0084,
        /// <summary>
    ...
    public struct NativeMessage
    {
        ...
        public void CopyTo(ref Message msg)
        {
            msg.HWnd = hwnd;
            msg.WParam = wParam;
            msg.LParam = lParam;
        ...
        {
            return string.Format("NativeMessage : {0} {1} {2} {3}", message.ToString(), wParam, lParam, point);
        }
    ...
    /// From http://www.pinvoke.net/default.aspx/Structures/RECT.html
    /// </summary>
    /// <remarks>
    ...
    public struct RawRectangle
    {
        ...
        public RawRectangle( Rectangle r) : this(r.Left, r.Top, r.Right, r.Bottom) { }
        ...
        public static implicit operator Rectangle(RawRectangle r)
        {
            return new Rectangle(r.Left, r.Top, r.Width, r.Height);
        }

        public static implicit operator ViewportClip(RawRectangle r)
        {
            return new ViewportClip(r.Left, r.Top, r.Width, r.Height);
        }

        public static implicit operator RawRectangle(Rectangle r)
        {
            return new RawRectangle(r);
        }

        public static bool operator ==(RawRectangle r1, RawRectangle r2)
        {
            return r1.Equals(r2);
        }
        ...
        public bool Equals(RawRectangle r)
        {
        ...
        {
            if (obj is RawRectangle)
                return Equals((RawRectangle)obj);
            else if (obj is  Rectangle)
                return Equals(new RawRectangle(( Rectangle)obj));
            return false;
        }
